...
export default class adminDashboard extends Component {
    constructor(props){
        ...
        this.state = {
            ...
            searching,
            currentPage,
            empRoleId: localStorage.getItem("role"),
            addModalShow: false,    
            editModalShow: false,
            emps: [],
            emp: []
    ...
    //     let temp = event.target.id.value
         
    //         fetch('https://localhost:44336/api/Employees/Search?id='+temp)
    //     //fetch('https://devgruems.azurewebsites.net/api/Employees/SearchByRole?id='+this.state.empRoleId)
    ...
    refreshList() {
                ...
                fetch('https://localhost:44336/api/Employees/SearchByRole?id='+this.state.empRoleId+'&&pageNumber='+this.state.currentPage+'&&pageSize='+5)
                //fetch('https://devgruems.azurewebsites.net/api/Employees/SearchByRole?id='+this.state.empRoleId+'&&pageNumber='+this.state.currentPage+'&&pageSize='+5)
                    .then(response => response.json())
                    .then(data => {
            ...
            <nav className="navbar navbar-expand-lg navbar-light fixed-top">
                ...
                <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
                    ...
                    {/* <Form inline onSubmit={this.handleSubmit}>
                        <FormControl type="text" name="id" placeholder="Search HR by Id" className="mr-sm-2" />
